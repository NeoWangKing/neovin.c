...
uint32_t *render(float dt)
{
    ...
    Vec3D a = Vec3D(-2, -2+dy, z);
    Vec3D b = Vec3D(2, -2+dy, z);
    ...
    NVC_Draw_Line_3D_Ex(oc, a, b, 2, 0xFF000000);
    NVC_Draw_Line_3D_Ex(oc, b, c, 2, 0xFF000000);
    NVC_Draw_Line_3D_Ex(oc, c, a, 2, 0xFF000000);
    //
